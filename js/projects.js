const projectList = [
  {
    name: 'Profile Page',
    title: 'Project 1 | My Personal Profile Page',
    github: 'https://github.com/saltymermaid/fewd-tech-degree-1',
    url: 'https://saltymermaid.github.io/fewd-tech-degree-1/',
    image: 'images/proj-1-personal-profile.png',
    description: 'This was the Hello, World project for the program. I was given a complete profile page and the assignment was to update it with my own text and images. For extra credit, I added things like additional pages and a CSS transition.',
    topics: [
      'Semantic HTML',
      'CSS transitions'
    ],
  ...
  },
  {
    ...
    title: 'Project 2 | Responsive Portfolio',
  ...
  },
  {
    ...
    title: 'Project 3 | An Online Registration Form',
    github: 'https://github.com/saltymermaid/fewd-techdegree-3',
    url: 'https://saltymermaid.github.io/fewd-techdegree-3/',
    image: 'images/proj-3-online-registration-form.png',
    description: "This was one of the hardest projects for me. This was my first introduction to CSS Flex Box and I spent a lot of time shaking my fist in the air and hurtling obscenities at my computer. I finally made peace with CSS when I accepted that if my button was in the wrong place it was because I did something to cause it to be in the wrong place. I really honed my Chrome dev tools skills working on this project. Although I've worked with forms before, using the pure HTML form fields allowed me to really understand how they work.",
    topics: [
      'Using Chrome dev tools to decipher CSS',
      'Using CSS Flex Box',
      'Using HTML forms'
    ],
    skills: [
  ...
  {
    name: 'Style Guide',
    title: 'Project 4 | Web Style Guide',
  ...
  {
    name: 'Photo Gallery',
    title: 'Project 5 | An Interactive Photo Gallery',
    github: 'https://github.com/saltymermaid/fewd-techdegree-5',
    url: 'https://saltymermaid.github.io/fewd-techdegree-5/',
    image: 'images/proj-5-interactive-photo-gallery.png',
  ...
  },
  {
    ...
    title: 'Project 6 | Wheel of Success Game',
    ...
    topics: [
      ...
      'More experience working with event listeners',
  ...
  },
  {
    ...
    title: 'Project 7 | WebApp Dashboard',
  ...
  },
  {
    ...
    title: 'Project 8 | Use an API to Create an Employee Directory',
